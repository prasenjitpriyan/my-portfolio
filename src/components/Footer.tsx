...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="h-[30svh] w-screen bg-slate-900 bg-[linear-gradient(to_right,#00adb52e_1px,transparent_1px),linear-gradient(to_bottom,#00adb52e_1px,transparent_1px)] bg-[size:14px_20px]">
